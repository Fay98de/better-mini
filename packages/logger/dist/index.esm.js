...
function getCurrentPageId() {
    var currentInstance = Taro.getCurrentInstance();
...
var Logger = /** @class */ (function (_super) {
    ...
    Logger.prototype.render = function () {
        ...
        if (!visible)
            return null;
        return (React.createElement(View, __assign({}, this.props, { className: classnames('logger-view', className, { show: show }) }),
            React.createElement(ScrollView, { className: "logger-list", scrollY: true, scrollIntoView: currentLogId }, logs.map(function (log, index) { return (React.createElement(Text, { key: index, id: log.id, className: classnames('logger-text', log.type), style: { backgroundColor: index % 2 ? '#eee' : undefined }, selectable: true }, log.text)); })),
